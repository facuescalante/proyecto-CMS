        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                <a href="{{ $post->slug }}" class="hover:opacity-75">
                    <img class="img" src="http://localhost:8000/storage/{{ $post->image_url }}" >
                ...
                <div class="bg-white flex flex-col justify-start p-6">
                    ...
                    <p href="#" class="text-sm pb-3">
                        By <a href="{{ $post->slug }}" class="font-semibold hover:text-gray-800">{{ $post->user->name }}</a>, Published on {{ $post->created_at }}
                    </p>
                    <a href="#" class="pb-6">{!! \Illuminate\Support\Str::limit($post->body, 100, '...') !!}</a>
